...
{
    struct cxl_event_log *log = cxl_event_log(cxlds, CXL_EVENT_TYPE_INFO);

    cxl_event_insert(log, &maint_needed);
    cxl_event_insert(log, (struct cxl_event_record_raw *)&gen_media);
    cxl_event_insert(log, (struct cxl_event_record_raw *)&mem_module);
    cxl_event_set_status(cxlds, CXL_EVENT_TYPE_INFO, true);

    log = cxl_event_log(cxlds, CXL_EVENT_TYPE_FAIL);
    cxl_event_insert(log, &maint_needed);
    ...
    cxl_event_insert(log, &hardware_replace);
    cxl_event_insert(log, (struct cxl_event_record_raw *)&dram);
    cxl_event_set_status(cxlds, CXL_EVENT_TYPE_FAIL, true);

    log = cxl_event_log(cxlds, CXL_EVENT_TYPE_FATAL);
    cxl_event_insert(log, &hardware_replace);
    cxl_event_insert(log, (struct cxl_event_record_raw *)&dram);
